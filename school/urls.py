...
from .views import StudentRetrieveUpdateDestroyView, GroupListCreateView,StudentListCreateView, GroupRetrieveUpdateDestroView,SubjectListCreateView, ExamListCreateView, ExamRetrieveUpdateDestroyView, SubjectRetrieveUpdateDestroyView, students_by_group,top_student_by_group
...
urlpatterns = [
     ...
     path('api/subject/<int:pk>', SubjectRetrieveUpdateDestroyView.as_view(),name='subject-update-delete-retrieve'),
     path('api/exam', ExamListCreateView.as_view(),name='exam-create-list'),
     path('api/exam/<int:pk>', ExamRetrieveUpdateDestroyView.as_view(),name='exam-update-delete-retrieve') 
]